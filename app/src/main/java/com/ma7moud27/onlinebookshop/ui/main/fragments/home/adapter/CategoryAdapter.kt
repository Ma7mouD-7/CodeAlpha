...
class CategoryAdapter(
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        holder.categoryCover.layoutParams.width = (holder.categoryCover.layoutParams.width * itemsList[position].width).toInt()
        holder.categoryCover.layoutParams.height = (holder.categoryCover.layoutParams.height * itemsList[position].height).toInt()
        holder.categoryName.text = itemsList[position].name.replace("_"," ").map { it}.joinToString("\n")
